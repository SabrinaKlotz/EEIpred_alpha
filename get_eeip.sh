...
python3 data_preprocessing/convert_pdb2npy.py

# Run dMaSIF predictions
python3 -W ignore -u main_inference_exon.py --experiment_name "$dataset/dMaSIF_search_3layer_12_${fold}_$dataset" --batch_size 1 --embedding_layer dMaSIF --search True --device cuda:"$cuda_no" --radius 12.0 --emb_dim 16 --n_layers 3 --train_no "$fold"
...
# Run PPDL
python3 /cosybio/project/EEIalpha/EEIpred/ppDL.py -mth dmasif -d "$dataset" -f "$fold"
